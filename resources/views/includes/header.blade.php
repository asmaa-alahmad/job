                        ...
                        <ul class="navbar-nav">
                            ...
                            @foreach ($show_in_top_menu as $top_menu)
                                ...
                                <li
                                    ...
                                    <a class="nav-link"
                                        href="{{ route('cms', $top_menu->page_slug) }}">{{ __($cmsContent->page_title) }}</a>
                                </li>
                            @endforeach
                            ...
                            @elseif(Auth::guard('company')->check())
                                <li class="nav-item register"><a href="{{ route('post.job') }}"
                                ...
                                <li class="nav-item dropdown userbtn"><a
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a href="{{ route('company.messages') }}"
                                                class="nav-link"><i class="fa fa-envelope" aria-hidden="true"></i>
                            ...
                            @if (!Auth::user() && !Auth::guard('company')->user())
                                <li class="nav-item loginbtn"><a href="javascript:void();" data-bs-toggle="modal"
                                        data-bs-target="#headlogin" class="nav-link">{{ __('Sign in') }}</a> </li>
                                <li class="nav-item register"><a href="javascript:void();" data-bs-toggle="modal"
                                        data-bs-target="#headregister"
                                        class="nav-link register">{{ __('Register') }}</a> </li>
                            @endif
                            <li class="dropdown userbtn"><a href="{{ url('/') }}"><img
                                        src="{{ asset('/') }}images/lang.png" alt="Change Language"
                                        class="userimg" /></a>
                                <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:;"
                                            ...
                                            <form id="locale-form-{{ $siteLang->iso_code }}"
                                                ...
                                                <input type="hidden" name="locale"
                                                    value="{{ $siteLang->iso_code }}" />
                                                <input type="hidden" name="return_url"
                                                    value="{{ url()->full() }}" />
                                                <input type="hidden" name="is_rtl"
                                                    value="{{ $siteLang->is_rtl }}" />
                                            </form>
                                        </li>
                                    @endforeach
                                </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="preuserinfo">
                    ...
                    <a href="javascript:void();" class="btn btn-yellow mt-3" data-bs-toggle="modal"
                        data-bs-target="#headlogin" class="nav-link">{{ __('Sign in') }}</a>
                    <a href="javascript:void();" class="btn btn-dark mt-3" data-bs-toggle="modal"
                        data-bs-target="#headregister" class="nav-link register">{{ __('Register') }}</a>
                </div>
            </div>
...
@if (Auth::check() && !Auth::guard('company')->check())
    <ul class="usernavdash" id="usermbnav">
        ...
        <li><a href="{{ route('resume', Auth::user()->id) }}" class="nav-link"><i class="fa fa-print"
                    aria-hidden="true"></i> {{ __('Download CV') }}</a></li>
...
@elseif(Auth::guard('company')->check())
    <ul class="usernavdash" id="usermbnav">
        ...
        <li class="nav-item"><a href="{{ route('posted.jobs') }}" class="nav-link"><i
                    class="fab fa-black-tie"></i> {{ __('Manage Jobs') }}</a></li>
        ...
        <li class="nav-item"><a href="{{ route('company.unloced-users') }}" class="nav-link"><i
                    class="fas fa-user" aria-hidden="true"></i> {{ __('Unlocked Users') }}</a></li>
