                        ...
                        <div class="seekerbox">
                            ...
                            <div class="hmseekerinfo">
                                ...
                                <div class="hmcate justify-content-center" title="Functional Area">
                                    {{ $jobSeeker->jobTitle->job_title }}</div>
                                <div class="hmcate justify-content-center" title="Career Level"><i
                                        class="fas fa-chart-line"></i> {{ $jobSeeker->jobExperience->job_experience }}
                                </div>
                                <div class="hmcate justify-content-center"><i class="fas fa-map-marker-alt"></i>
                                    {{ $jobSeeker->getCity('city') }}</div>
                                <div class="listbtn">

                                    @if (Auth::user() || (!Auth::user() && !Auth::guard('company')->user()))
                                        <a href="javascript:void();" data-bs-toggle="modal"
                                            data-bs-target="#hireme">{{ __('View Profile') }}</a>
                                    @else
                                        <a
