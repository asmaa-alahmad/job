<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Widget Title']) !!}
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('widget_page_id', ['' => 'Select Widget Page'] + $widget_pages, null, [
                'class' => 'form-control',
                'id' => 'widget_page_id',
            ]) !!}
        </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('is_description', $fields, null, ['class' => 'form-control', 'id' => 'is_description']) !!}
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('is_extra_image_title_1', $fields, null, [
                'class' => 'form-control',
                'id' => 'is_extra_image_title_1',
            ]) !!}
        </div>
    ...
    <div class="col-md-4 image_section">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_title_1', null, [
                'class' => 'form-control',
                'id' => 'extra_image_title_1',
                'placeholder' => 'Widget Image 1 Title',
            ]) !!}
        </div>
    </div>
    <div class="col-md-4 image_section">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_1_height', null, [
                'class' => 'form-control',
                'id' => 'extra_image_1_height',
    ...
    <div class="col-md-4 image_section">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_1_width', null, [
                'class' => 'form-control',
                'id' => 'extra_image_1_width',
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('is_extra_image_title_2', $fields, null, [
                'class' => 'form-control',
                'id' => 'is_extra_image_title_2',
            ]) !!}
        </div>
    ...
    <div class="col-md-4 image_section_2">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_title_2', null, [
                'class' => 'form-control',
                'id' => 'extra_image_title_2',
                'placeholder' => 'Widget Image 2 Title',
            ]) !!}
        </div>
    </div>
    <div class="col-md-4 image_section_2">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_2_height', null, [
                'class' => 'form-control',
                'id' => 'extra_image_2_height',
                'placeholder' => 'Thumbnail Height',
            ]) !!}
        </div>
    </div>
    <div class="col-md-4 image_section_2">
        <div class="form-group">
            ...
            {!! Form::text('extra_image_2_width', null, [
                'class' => 'form-control',
                'id' => 'extra_image_2_width',
                'placeholder' => 'Thumbnail Width',
            ]) !!}
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::select('extra_fields', ['' => 'Select Extra Fields'] + $extra_fields, null, [
                'class' => 'form-control',
                'id' => 'extra_fields',
            ]) !!}
        </div>
...
<div class="row">
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_1', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_1',
                'placeholder' => 'Extra Field Title 1',
            ]) !!}
        </div>
    </div>
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_2', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_2',
                'placeholder' => 'Extra Field Title 2',
            ]) !!}
        </div>
    </div>
    ...
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_3', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_3',
                'placeholder' => 'Extra Field Title 3',
            ]) !!}
        </div>
    </div>
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_4', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_4',
                'placeholder' => 'Extra Field Title 4',
            ]) !!}
        </div>
    </div>
    ...
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_5', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_5',
                'placeholder' => 'Extra Field Title 5',
            ]) !!}
        </div>
    </div>
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_6', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_6',
                'placeholder' => 'Extra Field Title 6',
            ]) !!}
        </div>
    </div>
    ...
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_7', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_7',
                'placeholder' => 'Extra Field Title 7',
            ]) !!}
        </div>
    </div>
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            {!! Form::label('extra_field_title_8', 'Extra Field Title 7', ['class' => 'font-weight-bold']) !!}
            {!! Form::text('extra_field_title_8', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_8',
                'placeholder' => 'Extra Field Title 8',
            ]) !!}
        </div>
    </div>
    <div class="col-md-12 extra_field_title" style="display: none;">
        <div class="form-group">
            ...
            {!! Form::text('extra_field_title_9', null, [
                'class' => 'form-control',
                'id' => 'extra_field_title_9',
                'placeholder' => 'Extra Field Title 9',
            ]) !!}
        </div>
    </div>
