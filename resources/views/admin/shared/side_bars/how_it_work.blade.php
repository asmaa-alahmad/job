<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="icon-wrench"></i> <span class="title fw-bold">how it work widget</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
