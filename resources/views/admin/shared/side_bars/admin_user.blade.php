...
<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle  {{ request()->routeIs('list.admin.users')||request()->routeIs('create.admin.user') ? 'active-menu' : '' }}"> <i class="icon-user"></i> <span class="title fw-bold">Admin Users</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
