...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
        ...
        @if (APAuthHelp::check(['SUP_ADM']))
            ...
            <li class="nav-item  "> <a href="{{ route('list.payment.hostory') }}" class="nav-link "> <span
                        class="title"> Companies Payment History</span> </a> </li>
            <li class="nav-item  "> <a href="{{ route('list.users.payment.history') }}" class="nav-link "> <span
                        class="title"> Jobseekers Payment History</span> </a> </li>
