                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Search Job Seekers</span> </div>
                                            ...
                                            <div class="row srcsubfld additional_fields">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="search" id="empsearch"
                                                        ...
                                                        maxlength="30" placeholder="{{ __('Job Seeker Name') }}"
                                                        autocomplete="off" /><br>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <span id="city_dd">
                                                        ...
                                                        {!! Form::select('city_id[]', ['' => __('Select City')], Request::get('city_id', null), [
                                                            'class' => 'form-control',
                                                            'id' => 'city_id',
                                                        ]) !!}
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    {!! Form::select('job_skill_id[]', $jobSkills, request()->job_skill_id, [
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    {!! Form::select('degree_id[]', ['' => __('Select Education')] + $degrees, request()->degree_id, [
                                                        'class' => 'form-control',
                                                        'id' => 'degree_id',
                                                    ]) !!}
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    {!! Form::select(
                                                        ...
                                                        ['class' => 'form-control', 'id' => 'job_experience_id'],
                                                    ) !!}
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    {!! Form::select(
                                                        'career_level_id[]',
                                                        ['' => __('Select Career Level')] + $careerLevels,
                                                        request()->career_level_id,
                                                        ['class' => 'form-control', 'id' => 'career_level_id'],
                                                    ) !!}
                                                    <br>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    {!! Form::select('industry_id[]', ['' => __('Select Industry')] + $industries, request()->industry_id, [
                                                        'class' => 'form-control',
                                                        'id' => 'industry_id',
                                                    ]) !!}
                                        ...
                                        @if (null !== $jobSeekers)
                                            @foreach ($jobSeekers as $seeker)
                                                <tr id="user_dt_row_{{ $seeker->id }}" role="row" class="odd">
                                                    ...
                                                    <td><a target="_blank"
                                                            href="{{ route('admin.view.public.profile', $seeker->id) }}">Profile</a>
                                                    </td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="showreslt">
                                                ...
                                                {{ __('Displaying Results') }} : {{ $jobSeekers->firstItem() }} -
                                                {{ $jobSeekers->lastItem() }} {{ __('Total') }}
                                                {{ $jobSeekers->total() }}
    ...
    <script type="text/javascript">
            ...
            sThisVal.forEach(function(item) {
                ...
                if (item != '') {
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('check-lock-unlock') }}?job_id=' + job_id + '&company_id=' +
                            company_id,
                        ...
                        success: function(data) {
                            ...
                            for (i = 0; i < arr.length; i++) {
                                ...
                                if ($.trim(arr[i]) == item) {
                                    ...
                                    $('#uniform-customcheck_' + item + ' span').addClass(
                                        'checked');
...

        {
            ...
            if (company_id != '') {
                ...
                $.post("{{ route('filter.default.jobs.dropdown') }}", {
            ...
            if (company_id != '' && company_id != 'Select Employer' && job_id != '' && job_id != 'Select Job') {
                ...
                if ($(this).is(':checked')) {
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('admin.company.unlock.future') }}?user_id=' + user_id +
                    ...
                    $.ajax({
                        ...
                        url: '{{ route('admin.company.lock') }}?user_id=' + user_id + '&company_id=' +
                            company_id + '&job_id=' + job_id,
