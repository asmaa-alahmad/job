...
<input type="hidden" id="data_filer_widget_image_1_{{ $wid->id }}" <?php if (isset($widget_data)) {
    echo 'value="' . $widget_data->extra_image_1 . '"';
} ?> name="extra_image_1">

<input type="hidden" id="data_filer_widget_image_2_{{ $wid->id }}" <?php if (isset($widget_data)) {
    echo 'value="' . $widget_data->extra_image_2 . '"';
} ?> name="extra_image_2">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('description', null, [
                    'class' => 'form-control',
                    'id' => 'description',
                    'placeholder' => $wid->title . ' Description',
                    'required' => 'required',
                ]) !!}
            </div>
        </div>
                ...
                <div class="form-radio">
                    <div class="radio radio-inline">
                        ...
                        <label>
                            ...
                            if (isset($widget_data) && $widget_data->$name == 1) {
                                echo 'checked';
                            } elseif (!isset($widget_data)) {
                                echo 'checked';
                            }
                            ?>>
                    ...
                    <div class="radio radio-inline">
                        <label>
                            <input type="radio" value="0" name="{{ $name }}" <?php if (isset($widget_data) && $widget_data->$name == 0) {
                                echo 'checked';
                            }
                            ?>>
                            <i class="helper"></i>No
