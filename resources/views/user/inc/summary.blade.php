    ...
    function submitProfileSummaryForm() {
        ...
        $.ajax({
            ...
            success: function (json) {
                $("#success_msg").html("<div class='alert alert-success alert-dismissible fade show' role='alert'>{{__('Summary updated successfully')}}<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>");
            },
            error: function (json) {
                if (json.status === 422) {
