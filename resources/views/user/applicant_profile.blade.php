                ...
                <div class="col-md-8">
                    ...
                    <div class="userMaininfo">
                        ...
                        <div class="title">
                            ...
                            <div class="desi"><i class="fa fa-map-marker" aria-hidden="true"></i>
                                {{ $user->getLocation() }}</div>

                            <div class="membersinc"><i class="fa fa-history" aria-hidden="true"></i>
                                {{ __('Member Since') }}, {{ $user->created_at->format('M d, Y') }}</div>
                    ...
                    <div class="userlinkstp">
                        ...
                        @elseif(auth()->check() && auth()->user()->id != $user->id)
                            {{-- Regular user viewing another user's profile --}}
                            <a href="javascript:;" onclick="send_message()" class="btn">
                                <i class="fa fa-envelope" aria-hidden="true"></i> {{ __('Send Message') }}
                            </a>
                        @endif
                        ...
                        @if (Auth::guard('company')->user())
                            @if ($true == false)
                                @if (!$isProfileComplete)
                                    <p style="color: red;">
                                        {{ __('Candidate profile is not completed, so you can\'t unlock it.') }}</p>
                                @else
