                        ...
                        @else
                            @if (!Auth::check())
                                @if ($job->application_url != '')
                                    <a href="{{ route('job.apply', $job->slug) }}" class="btn apply"><i
                                            class="fas fa-paper-plane" aria-hidden="true"></i> {{ __('Apply Now') }}</a>
                                @else
                            ...
                            @else
                                @php
                                    $user = Auth::user();
                                    $profileIncomplete =
                                        count($user->getProfileProjectsArray()) == 0 ||
                ...
                <div class="col-lg-5">
                    ...
                    <div class="job-header">
                        <div class="jobdetail">
                            ...
                            <div class="gmap">
                                <iframe
                                    src="https://maps.google.it/maps?q={{ urlencode(strip_tags($company->map)) }}&output=embed"
                ...
                <ul class="featuredlist row">
                            ...
                            @if (null !== $relatedJobCompany)
                                ...
                                <li class="col-lg-3 col-md-6">
                                    <div class="jobint">
                                        ...
                                        <div class="d-flex">
                                            <div class="fticon"><i class="fas fa-briefcase"></i>
                                                {{ $relatedJob->getJobType('job_type') }}</div>
                                        </div>
                                        <h4><a href="{{ route('job.detail', [$relatedJob->slug]) }}"
                                                title="{{ $relatedJob->title }}">{!! \Illuminate\Support\Str::limit($relatedJob->title, $limit = 20, $end = '...') !!}</a>
                                        </h4>
                                        ...
                                        <strong><i class="fas fa-map-marker-alt"></i>
                                            {{ $relatedJob->getCity('city') }}</strong>
                                        <div class="jobcompany">
                                            <div class="ftjobcomp">
                                                <span>{{ $relatedJob->created_at->format('M d, Y') }}</span>
                                                <a href="{{ route('company.detail', $relatedJobCompany->slug) }}"
                    ...
                    @else
                        <div class="nodatabox">
                            ...
                            <div class="viewallbtn mt-2"><a href="{{ url('/search-jobs') }}">{{ __('Search Jobs') }}</a>
                            </div>
                        </div>
                    @endif
