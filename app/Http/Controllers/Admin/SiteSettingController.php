...

{
...

    {
        ...
        $siteSetting->is_razorpay_active = $request->input('is_razorpay_active');

        // Paytm fields
        $siteSetting->paytm_merchant_key = $request->input('paytm_merchant_key');
        $siteSetting->paytm_merchant_id = $request->input('paytm_merchant_id');
        $siteSetting->paytm_website = $request->input('paytm_website');
        $siteSetting->paytm_industry_type = $request->input('paytm_industry_type');
        $siteSetting->paytm_channel_id = $request->input('paytm_channel_id');
        $siteSetting->is_paytm_active = $request->input('is_paytm_active');

        $siteSetting->is_jobseeker_package_active = $request->input('is_jobseeker_package_active');
        $siteSetting->auto_approval_company = $request->input('auto_approval_company');
        $siteSetting->auto_approval_job = $request->input('auto_approval_job');
        ...
        $siteSetting->is_paystack_active = $request->input('is_paystack_active');
        $siteSetting->paystack_key = $request->input('paystack_key');
        $siteSetting->paystack_secret = $request->input('paystack_secret');
