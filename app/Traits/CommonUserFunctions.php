...
trait CommonUserFunctions
{
    ...
    private function updateUserFullTextSearch($user)
    {
        ...
        $str .= ' ' . \Carbon\Carbon::parse($user->date_of_birth)->format('Y-m-d');
        $str .= ' ' . $user->phone;
        $str .= ' ' . $user->mobile_num;
        ...
        $str .= ' ' . $user->getProfileLanguagesStr();
        $str .= ' ' . $user->getProfileEducationStr();
        $str .= ' ' . $user->getProfileSummaryStr();
        $str .= ' ' . $user->getProfileExperienceStr();
