...
Route::get('delete-users', array_merge(['uses' => 'Admin\UserController@deleteUsers'], $all_users))->name('delete.users');
Route::get('view-public-profile/{id}', 'AjaxController@viewpublicprofile')->name('admin.view.public.profile');

// Jobseeker Payment History
Route::get('list-users-payment-history', array_merge(['uses' => 'Admin\UserController@indexUsersHistory'], $all_users))->name('list.users.payment.history');
Route::get('fetch-users-payment-history', array_merge(['uses' => 'Admin\UserController@fetchUsersHistory'], $all_users))->name('fetch.data.usersHistory');
Route::get('get-user-payment-details', array_merge(['uses' => 'Admin\UserController@getUserPaymentDetails'], $all_users))->name('get.user.payment.details');
